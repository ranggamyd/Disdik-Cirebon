			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="nama_pendidikan" placeholder="Nama Pendidikan" class="form-control" value="{{ $pendidikan->nama_pendidikan }}" required>
						<span class="invalid-feedback"></span>
					</div>
					
					<div class="form-group">
						<label> Singkatan {!! Template::required() !!} </label>
						<input type="text" name="singkatan" placeholder="Singkatan" class="form-control" value="{{ $pendidikan->singkatan }}" required>
						<span class="invalid-feedback"></span>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="deskripsi" placeholder="Deskripsi" class="form-control" value="{{ $pendidikan->deskripsi }}" required>
						<span class="invalid-feedback"></span>
					</div>
...
<script>
	...
	$(function(){
		...
		$form.find(`[name="id_kategori"]`).val(`{{ $pendidikan->id_kategori }}`).trigger('change')
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url: `{{ route('pendidikan.update', $pendidikan->id_pendidikan) }}`,
				method: 'PUT',
				data: formData,
				dataType: 'json'
			})
