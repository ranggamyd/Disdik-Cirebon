			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="nama_lengkap" placeholder="Nama Lengkap" class="form-control" value="{{ $admin->nama_lengkap }}" required>
					...
					<div class="form-group">
						...
						<input type="text" name="no_telp" placeholder="No Telepon" class="form-control" value="{{ $admin->no_telp }}" required>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Alamat {!! Template::required() !!} </label>
						<input type="text" name="alamat" placeholder="Alamat" class="form-control" value="{{ $admin->alamat }}" required>
						<span class="invalid-feedback"></span>
					</div>
...
<script>
	...
	$(function(){
		...
		$form.find(`[name="jk"]`).val(`{{ $admin->jk }}`);
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url: `{{ route('user.update', $admin->id_admin) }}`,
				method: 'PUT',
				data: formData,
				dataType: 'json'
			})
